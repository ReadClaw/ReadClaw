...
我所设想的工程问题和解决要点：
（宇宙有无数的星球，每个星球因为环境的差异，针对每个星球问题提出的解决思路皆不相同，（譬如恒星戴森球、金星大气层气球宜居、火星基地等），然而原理共通：发射传感器、组网探测、逐步构建，本文对于岩质星球是以了解较多的月球为举例，实际对象并非指月球，而是用月球来举例。而其它岩质星球例如水星、火星、火卫一等，皆可以替换
