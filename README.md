...
> ❗说明：虽然本文提到人类登上天体为最终目标（依据黄金法则之：有人类连续驻扎365天为基准），但是项目在多数进程周期并非设定为人类的登陆。而是：从地球上项目开启直至实现在天体居住、生产、建设，皆为信息和非生命体的投放。因此，我们并非在反对载人航天探索，而是不倡议“短时期内大规模化的人类迁居”，请避免误读。同时，宇宙有无数的星球，每个星球因为天体自身差异，针对每个星球难题所提出的解决思路必不相同。譬如人们提出恒星戴森球、金星大气层气球宜居、火星大气升温等等设想，并不适配特定星球。本文以岩质星展开说明，为便于阅读者理解，就以人类了解较多的月球为举例，并非是开源建设月球，而仅仅为举例。
>
>
> 然而原理共通：发射传感器、组网探测、逐步构建，本文对于岩质星球是以了解较多的月球为举例，实际对象并非指月球，而是用月球来举例。而其它岩质星球例如水星、火星、火卫一等，皆可以替换

从传感器说起：价格、工艺成熟、坚固可靠性、部署投放易、危险性、失败率（科学仪器整合体极易失败，举例：）、组网和广域、可制作成信标和热点、灵敏的视觉/听觉/触觉的神经线、易于编程、组网易、属于信息基础建设、调配灵活、易于大范围调制、易形成共识、环境感知熟悉物理世界减少臆想性协助后续登陆、
